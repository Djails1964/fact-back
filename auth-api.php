...
require_once __DIR__ . '/services/ServiceAuthentification.php';
...
try {
    ...
    if (isset($_GET['version'])) {
        echo json_encode([
            ...
            'appName' => env('APP_NAME', 'Facturation'),
            'copyright' => env('APP_COPYRIGHT', '© 2025 Centre La Grange. Tous droits réservés.')
        ]);
        exit;
    }
